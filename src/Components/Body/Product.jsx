...
const Product = (props) => {
    const {img,name,price,ratings,ratingsCount,seller,shipping,stock} = props.product;
    return (
        <div className='border p-5 rounded-md relative'>
            ...
            <button className='w-full text-center border-b-2 text-white text-sm py-3 absolute bottom-0 left-0 right-0 rounded-b-md bg-yellow-500'>Add to cart</button>
